This README file tries to clarify the MATLAB codes used to elaborate the paper "Trends in Temperature 
Data: Micro-foundations of Their Nature", by Gadea, M.D., Gonzalo, J. and A. Ramos.

The main purpose is ...
-------------------------------------------------------------------------------------------------
The folders EMPIRICAL and SIMULATIONS contain the codes to reproduce the results of the paper
The folder funcions contains several auxiliary funcions
